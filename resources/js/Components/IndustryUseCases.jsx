    ...
    <section ref={sectionRef} className="py-24 bg-white dark:bg-slate-900 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div ref={itemsRef} className="grid md:grid-cols-3 gap-8">
          <div className="text-center p-10 bg-slate-50 dark:bg-slate-800 rounded-3xl border border-slate-100 dark:border-slate-700 hover:bg-white dark:hover:bg-slate-700 hover:shadow-2xl transition-all opacity-0">
            ...
            <h3 className="text-xl font-bold text-secondary dark:text-white mb-4 transition-colors">F&amp;B (Kedai &amp; Resto)</h3>
          ...
          <div className="text-center p-10 bg-slate-50 dark:bg-slate-800 rounded-3xl border border-slate-100 dark:border-slate-700 hover:bg-white dark:hover:bg-slate-700 hover:shadow-2xl transition-all opacity-0">
            ...
            <h3 className="text-xl font-bold text-secondary dark:text-white mb-4 transition-colors">Retail &amp; Toko Kelontong</h3>
          ...
          <div className="text-center p-10 bg-slate-50 dark:bg-slate-800 rounded-3xl border border-slate-100 dark:border-slate-700 hover:bg-white dark:hover:bg-slate-700 hover:shadow-2xl transition-all opacity-0">
            ...
            <h3 className="text-xl font-bold text-secondary dark:text-white mb-4 transition-colors">Jasa &amp; Freelance</h3>
