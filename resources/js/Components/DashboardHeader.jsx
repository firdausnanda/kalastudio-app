      ...
      {auth.is_impersonating && (
        <div className="bg-emerald-600 text-white py-2 px-4 flex items-center justify-center gap-4 text-xs font-black uppercase tracking-widest z-[60]">
          <span className="flex items-center gap-2">
            ...
            Anda sedang impersonate {user?.name}
          </span>
          <a
            href={route('impersonate.leave')}
            className="bg-white text-emerald-600 px-3 py-1 rounded-lg hover:bg-emerald-50 transition-colors"
          >
            Keluar & Kembali ke Admin
          </a>
        </div>
      )}
