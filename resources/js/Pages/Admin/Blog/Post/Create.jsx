...
export default function PostCreate({ auth, categories, tags }) {
                    ...
                    <form onSubmit={submit} className="max-w-[1400px] mx-auto">
                        <div className="flex items-center justify-between gap-4 mb-8">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h2 className="text-3xl font-black text-slate-900 dark:text-white tracking-tight">Tulis Artikel Baru</h2>
                                </div>
                            </div>
                            ...
                            <div className="lg:col-span-4 space-y-6 lg:sticky lg:top-24 h-max">
                                ...
                                <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-100 dark:border-slate-800 shadow-lg shadow-slate-200/20 dark:shadow-none">
                                    ...
                                    <div 
                                        ...
                                        className="mt-2 flex justify-center px-6 pt-5 pb-6 border-2 border-slate-300 dark:border-slate-700 border-dashed rounded-2xl hover:border-red-500 dark:hover:border-red-500 hover:bg-red-50 dark:hover:bg-red-500/5 transition-all group relative cursor-pointer overflow-hidden"
                                    >
                                        <div className="space-y-1 text-center relative z-10 w-full">
                                            ...
                                            <p className="text-xs text-slate-500 mt-2">
                                                {data.featured_image ? data.featured_image.name : 'PNG, JPG, GIF up to 2MB'}
                                            </p>
                                        </div>
                                    </div>
