                ...
                <main className="flex-grow p-4 md:p-8 lg:p-10 transition-all duration-300">
                    <div className="max-w-4xl mx-auto space-y-8">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h2 className="text-3xl font-black text-slate-900 dark:text-white tracking-tight">Tambah Lowongan</h2>
                                <p className="text-slate-500 dark:text-slate-400 font-medium">Buat postingan lowongan kerja baru.</p>
                            </div>
                        </div>
                        ...
                        <form onSubmit={submit} className="bg-white dark:bg-slate-900 rounded-[32px] border border-slate-100 dark:border-slate-800 shadow-xl p-8 md:p-10 space-y-8">
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea
                                    ...
                                    placeholder="Jelaskan peran dan tanggung jawab pekerjaan ini..."
                                    required
                                />
                            ...
                            <div className="flex flex-wrap gap-8 py-4 border-y border-slate-50 dark:border-slate-800">
                                <label className="flex items-center gap-3 cursor-pointer group">
                                    ...
                                    <span className="text-sm font-bold text-slate-700 dark:text-slate-300 group-hover:text-red-500 transition-colors">Aktif (Publikasikan)</span>
                                </label>
                                ...
                                <label className="flex items-center gap-3 cursor-pointer group">
                                    ...
                                    <span className="text-sm font-bold text-slate-700 dark:text-slate-300 group-hover:text-red-500 transition-colors">Tampilkan di Paling Atas (Featured)</span>
                                </label>
                            </div>
