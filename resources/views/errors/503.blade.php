...
<body>
  <div class="container">
    ...
    <div class="logo">
      <span style="font-weight: 800; font-size: 1.5rem; letter-spacing: -1px; color: var(--primary)">KALA<span
          style="color: var(--text-dark)">STUDIO</span></span>
    </div>
    ...
    <p>
      Kami sedang melakukan peningkatan sistem untuk memberikan pengalaman terbaik dalam mengelola keuangan bisnis Anda.
      Mohon tunggu sebentar, kami akan segera kembali.
    </p>

    <div class="actions">
      <a href="/" class="btn btn-primary">Coba Lagi</a>
      <a href="mailto:team@kalastudioai.com" class="btn btn-secondary">Hubungi Support</a>
    </div>
  </div>
</body>
